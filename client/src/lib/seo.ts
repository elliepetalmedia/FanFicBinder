...
export const seoRoutes = {
  ...
  ao3ToEpub: {
    ...
    description: "Use FanFicBinder to turn readable AO3 chapter pages into EPUB files, especially when you want your own chapter order or metadata workflow.",
    llmSummary: "AO3-specific guidance for readable chapter fetching, chapter ordering, and EPUB export without claiming unsupported integrations.",
    changefreq: "monthly",
    lastModified: "2026-05-22",
    priority: "0.78",
    ogType: "article",
    ...
    jsonLd: [
      articleJsonLd(
        ...
        "Use FanFicBinder with readable AO3 chapter pages when you want a custom EPUB workflow.",
      ),
      howToJsonLd(
        "/guides/ao3-to-epub",
        "Create an EPUB from AO3 pages",
        "Fetch readable AO3 chapter pages into FanFicBinder and export them as EPUB.",
        [
          "Open an AO3 chapter page in your browser and confirm the text is readable.",
          "Paste the chapter URL into FanFicBinder.",
          "Review each fetched chapter before continuing.",
